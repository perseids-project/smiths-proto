	...
	var regex = new RegExp( regexS );
  	...
  	if (results == null)
    	return;
  		...
  		submessage1.innerHTML = "We have attempted to automatically redirect you to the corresponding page in the new version. If we encountered an error in the redirect process, we have sent you to our home page. For further help, please contact perseus_webmaster@tufts.edu."
